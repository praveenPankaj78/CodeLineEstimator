...
public class JavaLang {
	...
	private final ArrayList<String> VARSYMBOLS = new ArrayList<String>(Arrays.asList("int", "char", "String", "byte", "float", "double", "long", "short", "boolean", "Character", "Integer", "Boolean"));
